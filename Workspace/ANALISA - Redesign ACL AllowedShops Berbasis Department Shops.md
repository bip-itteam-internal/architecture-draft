...
- ✅ **Fase Contract SELESAI (2026-09-15)**: `team_members`/`team_shops`/CRUD/menu `/integration/teams`/`ListTeamIDsByEmployee`/`ListShopsByTeamIDs` dicabut fisik (bip-erp PR #1888, erp-frontend PR #1579). Lihat [[ADR - 0045 Identitas Tim Tunggal dan Peta Kepemilikan Marketing]] §Migrasi langkah 4 untuk detail lengkap.
