...
- [ ] **T5 Rename 5 magang September ke `BIP-MG-`.** `BIP-1008..1012-09-26` → `BIP-MG-1008..1012-09-26`, nomor dipertahankan. Bisa memakai skrip Agustus yang diperbarui target-nya, atau alat T4 bila sudah jadi. Tulis prod = dijalankan manusia. Dependensi: sebelum seed T1 (lihat T1).
