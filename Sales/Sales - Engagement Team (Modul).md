...
- **Perubahan 2026-09-21** (branch `feat/engagement-realisasi-per-jenis`, **belum merge, belum deploy**, keputusan [[ADR - 0117 Realisasi Engagement Dilaporkan Pengerja per URL per Jenis Pekerjaan sampai Akhir Bulan KPI]]): jenis pekerjaan dan target pindah ke tingkat URL, dan pengerja melaporkan realisasi per URL per jenis. Sebelum ini `volume_realisasi` **tak punya penulis mana pun** dan metrik Quantity selalu 0. Bagian yang sudah diperbarui: **Siklus hidup**, **Konsumen Data**, dan butir 8 di **Cacat yang Diketahui**.
...
- **Apakah menandai Selesai mensyaratkan realisasi sudah dilaporkan**, dan apakah atribusi periode KPI diselaraskan ke WIB: lihat TBD di [[ADR - 0117 Realisasi Engagement Dilaporkan Pengerja per URL per Jenis Pekerjaan sampai Akhir Bulan KPI]].
