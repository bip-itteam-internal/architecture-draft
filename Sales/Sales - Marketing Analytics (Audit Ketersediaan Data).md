...
| Durasi · GMV/jam · Rev/1000 viewers | RAKIT | `start_time`/`end_time` ada. Durasi dan GMV/jam studio dirakit di `/lives/analisis` (di PROD sejak 2026-09-11): GMV per jam berpasangan dengan jam sesi yang sudah selesai. Rev/1000 viewers belum dirakit |
...
| Heatmap jam × hari | RAKIT | `start_time` + GMV sudah ada. Dirakit di `/lives/analisis` (di PROD sejak 2026-09-11): peta hari × jam WIB akun studio, GMV per sel **perkiraan** prorata waktu karena API tak memberi dimensi waktu di dalam sesi |
