...
- [[CORE - API Master Gateway]] — mempublish kelima rute publik tanpa JWT; juga meng-cache GET `/api/recruitment/*` 3 menit, kecuali **(T0a, #1832; dev naik 2026-09-11, prod menunggu deploy)** status massal, laporan, dan hasil tes kandidat (lihat catatan di atas).
