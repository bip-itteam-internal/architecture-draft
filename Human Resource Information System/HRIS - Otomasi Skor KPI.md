...
- **"Jumlah Affiliate Aktif" (affiliator baru bergabung) tetap MANUAL**: tak ada tanggal-join di data (TikTok Seller Affiliate Orders API hanya bawa waktu order) dan tak ada penanda perekrut — jadi tak ada dasar per-individu. Bukan terlewat; menunggu definisi terukur dari pemilik metrik.
