...
> **Status**: 🟡 dikodekan di bip-erp branch `feat/employee-kpi-target-insentif` (dua commit; test modul employee dan shared-library hijau dibanding baseline `origin/main`), **belum PR, belum deploy**. Rencana: `.task-plans/2026-09-07-employee-kpi-target-insentif.md`.
