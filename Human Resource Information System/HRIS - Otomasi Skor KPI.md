...
> **Status**: ⚠️ **merged ke `main`** (bip-erp PR [#1775](https://github.com/bip-itteam-internal/bip-erp/pull/1775), 2026-09-07 14:42 UTC), **dev ter-deploy dan terverifikasi** 2026-09-07 malam dengan data uji (katalog `target_dari_sumber`, `auto-values` tanpa dan dengan target insentif, KPI Saya; rincian di `Workspace/ANALISA - Target Profit Satu Pintu.md` §T2), **prod belum deploy**. Deploy: `employee-service` saja. Rencana: `.task-plans/2026-09-07-employee-kpi-target-insentif.md`.
