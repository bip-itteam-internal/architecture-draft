...
- **Status**: ⚠️ **MVP Implemented (ada catatan)** — live di dev + produksi 2026-08-06 dan terverifikasi lewat gateway 2026-08-19, kini dilayani **[[Microservices - Learning Service]]** (`/api/learning/*`), UI `/hris/training`. Sebelumnya menumpang Employee Service; dipindah lewat **LMS Fase 0** (bip-erp [#1020](https://github.com/bip-itteam-internal/bip-erp/pull/1020), erp-frontend [#814](https://github.com/bip-itteam-internal/erp-frontend/pull/814)). MVP awal: BE #545/#550 + FE #390/#391, refine FE #396. **Dua catatan yang menentukan jawaban "sudah ready?"**: (1) alur **karyawan biasa terputus** sejak 2026-08-13 karena menu web dicabut sebelum aplikasinya rilis, jadi yang terpakai baru sisi HR + supervisor; (2) **seluruh fitur LMS** (materi, kuis, skoring, kurikulum jabatan, Talent Pool) **belum ada kode sama sekali** — yang live adalah modul Pelatihan, bukan LMS.
- **Pengajuan & evaluasi (2026-08-11)**: BE [#1148](https://github.com/bip-itteam-internal/bip-erp/pull/1148)/[#1149](https://github.com/bip-itteam-internal/bip-erp/pull/1149)/[#1150](https://github.com/bip-itteam-internal/bip-erp/pull/1150) + FE [#967](https://github.com/bip-itteam-internal/erp-frontend/pull/967)/[#968](https://github.com/bip-itteam-internal/erp-frontend/pull/968) **merged**. Rantai persetujuan **SPV → HR** (dua tahap, bukan tiga — lihat alasannya di [[Microservices - Learning Service]]) dan penilaian trainer empat aspek dengan **ambang tiga responden**. Layar karyawan **Pelatihan Saya** menyusul di MyBharata [#112](https://github.com/bip-itteam-internal/my-bharata/pull/112), **merged ke `dev` 2026-08-11** (catatan lama "belum merge" sudah tidak berlaku) — tapi belum ikut rilis ke store, lihat butir alur di bawah.
...
- ⛔ **Alur karyawan biasa masih TERPUTUS per 2026-08-19.** Menu self-service pelatihan dicabut dari web 2026-08-13 ([erp-frontend#1022](https://github.com/bip-itteam-internal/erp-frontend/pull/1022)) mendahului rilis penggantinya, dan penggantinya belum datang: my-bharata [#115](https://github.com/bip-itteam-internal/my-bharata/pull/115) **masih OPEN** (belum di `dev` maupun `main`), sementara rilis yang terpasang di HP pemakai masih **1.14.5+135** sehingga #112 pun belum sampai. Karyawan tanpa bawahan dan tanpa izin `training.work` karena itu **tak punya satu pun jalan bermenu** untuk mengajukan pelatihan atau melihat pelatihannya sendiri. Buktinya di data: `training_request` di produksi **0 dokumen** walau endpointnya live sejak 2026-08-11. **Yang bisa dipakai HANYA sisi HR dan supervisor.**
