...
- **Urutan penutupan celah Training & Performance Officer** (keputusan user 2026-09-15, "cepat berangka dulu"): Tahap 1 sumber KPI pelatihan dan feed kalender (✅ live produksi 2026-09-15); Tahap 2 rencana pelatihan tahunan dan sertifikat PDF (🟡 desainnya di Rollout Bertahap, belum ada kode); Tahap 3 LMS penuh (materi PDF dan video, pre-test, kurikulum per jabatan), situs belajar `lms.bharatainternasional.com`, lalu Talent Pool beserta prasyarat kenaikan jenjang yang dicatat di [[HRIS - Career & Promotion]] (🟡 belum ada kode).
...
- [ ] **Fase lanjut B** — **Sertifikat PDF** (MinIO via [[Microservices - File Service]]). Per 2026-09-15 belum ada kode sertifikat di service `learning` (satu-satunya kemunculan kata *certificate* adalah paket `ca-certificates` di Dockerfile). 🟡 **Diputuskan 2026-09-15 untuk Tahap 2**: sertifikat terbit **otomatis saat lulus** post-test (atau saat hadir, untuk kelas tanpa post-test), penanda tangan diambil dari **pengaturan HR per perusahaan**, bernomor unik, dan PDF-nya **dibangkitkan saat diminta**, bukan disimpan ke MinIO seperti rencana awal di baris ini. Belum ada kode.
...
- [ ] **Rencana pelatihan** — tak ada entitas rencana (tahunan maupun bulanan) di `learning_db`; koleksinya per 2026-09-15 hanya `training_type`, `trainer`, `training`, `training_participant`, `training_request`, `trainer_evaluation`, `quiz`, `quiz_attempt`. Metrik "terlaksana sesuai rencana" karena itu tak punya pembanding. 🟡 **Diputuskan 2026-09-15 untuk Tahap 2**: rencana berbentuk **butir rencana per tahun**, tiap kelas ditautkan ke butirnya, dan metrik terlaksana = butir yang terlaksana dibagi butir yang direncanakan per bulan. Belum ada kode.
...
- [[Microservices - Learning Service]] (host modul) · [[Microservices - Employee Service]] (master karyawan/departemen) · [[Microservices - Notification Service]] · [[Microservices - File Service]] (sertifikat) · [[Microservices - Calendar Service]] (feed `training`, sejak 2026-09-15)
