...
- **Prasyarat psikotes untuk kenaikan jenjang** — dinyatakan user 2026-09-15: kenaikan level jabatan **biasanya** disertai **psikotes** dan **menyelesaikan LMS sesuai jabatan baru** (bagian LMS-nya sudah tercatat di butir di atas). Keadaan kode per 2026-09-15: modul psikotes **hanya melayani kandidat rekrutmen**. Sesinya dikunci `candidate_id` + `round_id` (`services/recruitment/models_psikotes.go:56`, index unik di `psikotes_index.go:46`), dan pesertanya pelamar tanpa akun ERP yang masuk lewat tautan email ([[HRIS - Bank Soal dan Paket Psikotes]]). Psikotes untuk karyawan internal karena itu **belum punya jalur**, dan pemeriksa prasyarat `psikotes` belum ada; kaitnya bisa menumpang `DaftarkanPrasyarat` yang sama dengan post-test.
	- ⚠️ **Belum diputuskan**: apakah psikotes **menahan** pencatatan promosi atau hanya bahan pertimbangan HR; paket tes mana untuk tiap jenjang tujuan; siapa yang memutus lulus atau tidak (di rekrutmen HR yang memutus Pass/Fail); dan apakah berlaku untuk seluruh perpindahan atau hanya kenaikan jenjang. Direncanakan bersama Talent Pool (fase lanjut LMS)
