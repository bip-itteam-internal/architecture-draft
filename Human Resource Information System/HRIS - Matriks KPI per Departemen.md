...
| 0.05 | `Customer Satisfactions untuk Produk Beautyhacks 4,5 dari 5` | Rating Toko > 4.5 | GET /task-management/report/csat. CATATAN: baru 8 tiket ter-rating seumur hidup, terlalu tipis. | Belum layak dipakai. Fiturnya ada, tapi baru 8 tiket yang pernah dinilai pemintanya, jadi angkanya belum bisa dipercaya. |
...
| 0.2 | `100% pembayaran dan pengeluaran sesuai rencana cashflow` | Memvalidasi dan mencatat pengeluaran operasional sebelum dibayarkan | Accurate live proxy: /accounting/profit-loss, /balance-sheet, /profit/cash-flow, /fixed-assets. | Bisa otomatis sekarang. Laporan laba rugi dan arus kas diambil langsung dari Accurate. |
| 0.2 | `Perhitungan harga pokok produksi (HPP)` | Costing HPP 95% valid dengan realisasi costing max 1 hari setelah permintaan | Accurate live proxy: /accounting/profit-loss, /balance-sheet, /profit/cash-flow, /fixed-assets. | Bisa otomatis sekarang. Laporan laba rugi dan arus kas diambil langsung dari Accurate. |
...
| 0.05 | `Employee Satisfaction` | Tingkat kepuasan pelayanan Team General Service minimal 90% memberikan penilaian 5 dari all karyawan | GET /task-management/report/csat. CATATAN: baru 8 tiket ter-rating seumur hidup, terlalu tipis. | Belum layak dipakai. Fiturnya ada, tapi baru 8 tiket yang pernah dinilai pemintanya, jadi angkanya belum bisa dipercaya. |
...
| 0.05 | `Customer Satisfactions untuk Produk Beautyhacks 4,5 dari 5` | Target Kepuasan Customer dengan target Rating Toko > 4.5 | GET /task-management/report/csat. CATATAN: baru 8 tiket ter-rating seumur hidup, terlalu tipis. | Belum layak dipakai. Fiturnya ada, tapi baru 8 tiket yang pernah dinilai pemintanya, jadi angkanya belum bisa dipercaya. |
...
| 0.2 | `Customer Satifaction` | Survey Penilaian Software yang sudah diimplementasikan | GET /task-management/report/csat. CATATAN: baru 8 tiket ter-rating seumur hidup, terlalu tipis. | Belum layak dipakai. Fiturnya ada, tapi baru 8 tiket yang pernah dinilai pemintanya, jadi angkanya belum bisa dipercaya. |
