...
>
> **Ralat 2026-09-18 untuk paruh rekrutmen:** sumber **`rekrutmen`** (enam metrik, grup `sdm`)
> sudah ditulis dan merged — rinciannya di [[#Recruitment & Onboarding]]. Ia **belum
> ter-deploy dan belum dipasang ke template mana pun**, jadi baris-baris rekrutmen di dokumen
> ini belum bergeser klasifikasinya. Paruh `stok` tidak berubah.
>
