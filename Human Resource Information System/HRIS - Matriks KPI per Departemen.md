...
Ringkasnya: 3 metrik (bobot 0,4: rencana, kehadiran, kepuasan) punya sumber otomatis live yang
sesuai definisinya; 2 metrik (bobot 0,5: skor penilaian training dan kesesuaian materi) sumbernya
**diputuskan ulang** lewat [[ADR - 0102 Kesesuaian Materi Dinilai Peserta dan Dampak Pelatihan dari Kenaikan Skor KPI]]
tetapi belum ada kodenya; 1 metrik (bobot 0,1, Employee Productivity) belum punya definisi maupun
sumber. Nol yang sudah dikonfigurasi di template.
