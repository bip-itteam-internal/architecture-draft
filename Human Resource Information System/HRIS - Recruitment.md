...
- [x] **Interview: skala angka 1-5, bentuk form dari sesi, rekap catatan bertipe**: BE [#1886](https://github.com/bip-itteam-internal/bip-erp/pull/1886) / FE [#1577](https://github.com/bip-itteam-internal/erp-frontend/pull/1577) (merged 2026-09-15; deploy belum diukur), lihat langkah 5 di atas dan [[Microservices - Recruitment Service]]
