...
- [ ] **Interview: skala angka 1-5, bentuk form dari sesi, rekap catatan bertipe**: 🟡 BE `feat/recruitment-assigned-form-type` / FE `feat/interview-feedback-skala-angka` (2026-09-14, belum merge), lihat langkah 5 di atas dan [[Microservices - Recruitment Service]]
