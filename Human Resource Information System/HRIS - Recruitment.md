...
⚠️ **Data modul ini kini juga jadi bahan KPI otomatis** (bip-erp [#1967](https://github.com/bip-itteam-internal/bip-erp/pull/1967), erp-frontend [#1644](https://github.com/bip-itteam-internal/erp-frontend/pull/1644), **merged 2026-09-18, belum di-deploy dan belum dipasang ke template mana pun**). Sumber `rekrutmen` di [[Microservices - Employee Service]] membaca requisition beserta jejak persetujuannya, kandidat berstatus Buffer, cakupan MPP, dan keputusan Performance Review Onboarding lewat dua rute berkunci layanan di [[Microservices - Recruitment Service]]. Konsekuensinya untuk pemakai menu ini: **jejak yang tidak diisi menurunkan skor orang lain**. Requisition tanpa audit persetujuan, kandidat Hired yang tak melamar lewat lowongan requisition-nya, dan posisi Buffer yang ejaannya tak berpadanan dengan MPP semuanya dikecualikan dari hitungan, dan jumlahnya ditampilkan sebagai baris pengecualian di rincian metrik. Metrik dan definisinya: [[HRIS - Matriks KPI per Departemen]].
