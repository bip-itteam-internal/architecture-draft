- **Status**: 🟡 Konsep / Overview — peta domain GA; mayoritas subsistem masih rencana.
...
5. Peralatan K3 Konstruksi
6. Peralatan K3 Listrik dan petir
7. Peralatan K3 Mekanik dan PUBT
8. Peralatan P3K
9. Implementasi ISO 22000 (standar internasional untuk Sistem Manajemen Keamanan Pangan (FSMS) yang berlaku untuk semua organisasi dalam rantai pasokan makanan, mulai dari produsen hingga konsumen akhir)
10. Dokumen dan Implementasi program kecelakaan kerja
11. Implementasi Checklist Management System (Checklist untuk masing-masing fungsi di General Affairs)
	...
	(dan seterusnya)
12. Implementasi Risk Management System
13. Implementasi Waste Management System
14. Implementasi Building Maintenance System (Kerusakan, kebersihan dan sanitasi gedung)
