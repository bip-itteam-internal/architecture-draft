...
Jumlah BKK per bulan per CV (ekspor AppSheet), transaksi Kopra per rekening per bulan, lama dari disetujui sampai ditransfer, jumlah pengetikan ulang per pembayaran (target satu).
