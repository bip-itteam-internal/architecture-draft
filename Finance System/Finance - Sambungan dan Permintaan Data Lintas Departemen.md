...
| Marketing | Target profit per orang diketik Supervisor divisinya; toko terpetakan ke ICC | Insentif | Penulisan target satu pintu sudah jalan; atribusi toko dan target Leader belum lengkap | P12 |
| HR | Beban karyawan dari payroll untuk biaya operasional insentif | Payroll, insentif | Dibaca dari payroll; ikut keadaan run payroll di prod | P7, P12 |
| GA | Aset baru melewati jalur aset dengan GA sebagai penyetuju; aset GA dipadankan ke nomor aset Accurate | Procurement, inventory | Jalur aset dan padanan ada; pemberitahuan ke pencatat aset di Finance belum diperiksa | P1, P13 |
...
| Pencapaian target profit, penilaian realisasi iklan | Departemen lain (peminta tidak disebut di survei) | Cost Control | P12, P9 | Dashboard insentif yang sudah ada ([[Finance - Incentive]]); apakah cakupannya sama dengan yang diminta: TBD |
| Daftar perlengkapan atau aset tetap | Departemen lain (peminta tidak disebut di survei) | Junior Accountant | P13 | Salinan aktiva tetap Accurate dan daftar aset GA yang sudah ada, dibaca sesuai hak akses; cakupannya terhadap yang diminta: TBD |
...
- Siapa yang meminta daftar perlengkapan dan aset tetap, dan untuk keperluan apa.

## Dokumen Terkait

- [[Finance - Proses Bisnis dan Kebutuhan Sistem]] · [[Finance - Kalender dan Rantai Tenggat]] · [[Finance - FAT Persona]]
- [[REF - Kepemilikan Data]] · [[Microservices - Procurement Service]] · [[Microservices - Payroll Service]] · [[Microservices - Manufacture Service]] · [[Microservices - Integration Service]] · [[Finance - Incentive]] · [[Microservices - Insentive Service]] · [[Microservices - Inventory Service]]
