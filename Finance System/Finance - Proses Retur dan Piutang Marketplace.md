...
- **B** Satu daftar pengecualian retur dan piutang di ERP untuk menggantikan basis data kerja. 🟡 Sisi retur diusulkan jadi tab **Selisih Retur** di Auto Sync Retur ([[ADR - 0103 Selisih Retur Dihitung Terjadwal per Periode dan Bisa Ditandai Beres]], 2026-09-17): menunggu scan >30 hari, dibukukan tanpa scan, komponen paket belum discan, scan tak sampai pembukuan, dan (Tahap 2) catatan ERP berbeda dari isi Accurate. **Piutang minus dan retur yang lolos sinkron belum tercakup** di sana.
...
- [[ADR - 0024 Retur Gerbang Payout + Tanggal per-Solution]] · [[ADR - 0025 Log Sumber vs Input WMS + Stempel Penginput]] · [[ADR - 0103 Selisih Retur Dihitung Terjadwal per Periode dan Bisa Ditandai Beres]] · [[Microservices - Integration Service]]
