...
| **Bekukan periode / setujui insentif** (⚠️ live DEV 2026-09-25, prod belum; penyetuju juga butuh paket menu "Menu: Insentif Profit" untuk melihat daftarnya) | Bekukan: `finance.insentif.freeze` (staf Finance ke atas). Setujui: `finance.insentif.approve` (supervisor/admin Finance, termasuk Direktur). Tidak seorang pun menyetujui insentif miliknya sendiri; atasan marketing tidak lagi menyetujui. [[ADR - 0125 Insentif Profit Dibayar lewat Slip Gaji dari Snapshot yang Disetujui Finance]] |
