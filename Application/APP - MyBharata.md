...
- ⚠️ **Post-test dan course belum ada di aplikasi.** Nol pemanggil `/me/post-test` maupun `/courses` di `origin/dev` (diperiksa 2026-09-15), dan komentar `home_quick_access.dart:95` menyebut isinya belum LMS penuh, padahal backend post-test sudah live ([[Microservices - Learning Service]]).
