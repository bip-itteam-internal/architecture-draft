...
- ⚠️ **Post-test dan course belum ada di `origin/dev`** — nol pemanggil `/me/post-test` maupun `/courses` (diperiksa 2026-09-15), dan komentar `home_quick_access.dart:95` menyebut isinya belum LMS penuh, padahal backend post-test sudah live ([[Microservices - Learning Service]]). 🟡 **Menyusul, belum merge**: my-bharata PR [#151](https://github.com/bip-itteam-internal/my-bharata/pull/151) (branch `feat/post-test-peserta` ke `dev`, **TERBUKA**, diukur 2026-09-16) menambahkannya sekaligus menata ulang menu Pelatihan — lihat [[#Post-test Peserta dan Penyatuan Menu Pelatihan]] di bawah.
...
- **`/pengajuan-pelatihan`** menumpang `features/training/` yang sudah ada: daftar pengajuan sendiri (`as=self`) berikut kedua tahap peninjauan dan catatan penolakannya, formulir topik/alasan/perkiraan biaya, dan pembatalan untuk yang masih menunggu keputusan. 🟡 **Menyusul, belum merge**: my-bharata PR [#151](https://github.com/bip-itteam-internal/my-bharata/pull/151) menyatukan halaman ini dengan Pelatihan Saya jadi dua tab satu layar dan memindahkan formulirnya dari bottom sheet ke halaman penuh — lihat [[#Post-test Peserta dan Penyatuan Menu Pelatihan]].
...
## Post-test Peserta dan Penyatuan Menu Pelatihan (🟡 my-bharata PR [#151](https://github.com/bip-itteam-internal/my-bharata/pull/151), branch `feat/post-test-peserta` ke `dev`, **TERBUKA, belum merge, belum deploy** — diukur 2026-09-16)
