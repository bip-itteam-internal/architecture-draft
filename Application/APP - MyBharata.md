...
- **Status**: ✅ Implemented — aplikasi HRIS mobile produksi (Flutter, Android/iOS). **Rilis di HP pemakai: `1.14.5+135`** (`origin/main`, GitHub Release 2026-08-03; masih rilis GitHub terbaru per 2026-09-15); `origin/dev` sudah di **`1.18.1+163`** (diukur 2026-09-15) dan belum ditarik ke `main`, jadi PR sesudah 135, termasuk **Pelatihan Saya** (#112) dan **Pengajuan Pelatihan** (#115), belum ada di rilis GitHub itu. Angka lama "rilis dev 1.10.2+104" dan "dev 1.14.9+143" di baris ini sudah tidak berlaku.
