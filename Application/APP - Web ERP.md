...
- **Stok Accurate** (`/integration-accurate/stok`): pembanding stok read-only. v2 (🟡 PR #230): 2 tab — "Stok Gudang" (semua item + qty dari salinan lokal, badge live/sync, cari, auto-refresh 60s) + "Stok per Listing" (SKU listing → komponen bundle → stok efektif; incl. cek live per-SKU).
