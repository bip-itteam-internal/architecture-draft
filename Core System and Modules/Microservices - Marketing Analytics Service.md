...
🟡 **Belum merged, belum deploy** (bip-erp `feat/marketing-analytics-monitoring-sesi-live`). Layar web sesi berjalan dan riwayat per sesi untuk leader marketing dan jabatan Live Support, keputusannya [[ADR - 0108 Monitoring Sesi Live di Web Hanya Baca untuk Leader dan Live Support]]. Berkas `live_support_sesi.go`; rute per baris di [[API - Marketing Analytics Service]] § Monitoring sesi live.
