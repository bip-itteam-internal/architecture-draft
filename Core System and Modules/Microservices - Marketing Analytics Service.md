...
> ⛔ **Klien pencatat sejak 2026-09-11 hanya MyBharata.** Halaman web Sesi Live Host (`/marketing-analytics/live-shift`) dihapus beserta menunya ([[ADR - 0091 Pencatatan Sesi Live Host Hanya di MyBharata, Halaman Web Dihapus]], erp-frontend branch `chore/hapus-sesi-live-host-web`, belum merged). Rute di bawah tidak berubah, dan `GET /live-shifts/performa` tetap dibaca Analisis Live dan panel ICC. Keterangan layar web di bagian-bagian berikut adalah riwayat.
...
- ⛔ **Halaman web Sesi Live Host dihapus** (2026-09-11, [[ADR - 0091 Pencatatan Sesi Live Host Hanya di MyBharata, Halaman Web Dihapus]]; erp-frontend branch `chore/hapus-sesi-live-host-web`, belum merged): pencatatan hanya dari MyBharata, leader tak lagi punya riwayat per sesi seluruh tim di layar mana pun, dan tombol Ambil alih versi web (ADR 0088 T3) batal. Prasyarat deploy `frontend-hris`: host aktif sudah memakai build MyBharata yang memuat Sesi Live.
