...
- ✅ `/public/recruitment/track/:token` **dibuang dari gateway** di bip-erp #1824 (merged 2026-09-10, `a0260e4d`). Rute ini sebelumnya YATIM: masih terdaftar dan meneruskan ke `<recruitment>/public/track/<token>`, padahal handler-nya sudah dihapus dari recruitment-service (`a298ba70`, 2026-07-24), sehingga membalas **404 Fiber**. Biner API-Gateway dev sudah bersih (string `recruitment/track` = 0, diukur 2026-09-10); **prod baru bersih sesudah api-gateway prod di-deploy ulang**. Lihat [[API - Recruitment Service]] §Publik
