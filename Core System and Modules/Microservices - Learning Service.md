...
⚠️ Dibaca dari branch `feat/learning-post-test-batas`, PR bip-erp [#1913](https://github.com/bip-itteam-internal/bip-erp/pull/1913) — **belum ada di `origin/main`, belum dideploy** (diukur 2026-09-16). Dua PR klien menyertainya: erp-frontend [#1603](https://github.com/bip-itteam-internal/erp-frontend/pull/1603) dan my-bharata [#151](https://github.com/bip-itteam-internal/my-bharata/pull/151).
...
⚠️ Kode di branch `be-rencana` (`services/learning/models_rencana.go`, `rencana.go`, `kpi_rencana_pelatihan.go`, `rencana_tautan.go`), bagian Tahap 2 Training & Performance Officer. **Belum merged ke `main`, belum dideploy ke dev maupun produksi** — PR bip-erp #1903 dan #1904 (keduanya TERBUKA per 2026-09-16).
