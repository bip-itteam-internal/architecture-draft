...
- **AI CV screening** (LLM OpenRouter + OCR) = **fase lanjut**. *(**Psikotes online BUKAN lagi fase lanjut** — sudah dibangun, lihat [[HRIS - Psikotes Kraepelin]]. CFIT dan DISC dikodekan 2026-09-11 lewat katalog dan paket, belum merged: [[HRIS - Bank Soal dan Paket Psikotes]].)*
