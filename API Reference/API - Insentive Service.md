...
| GET/POST | `/profit/targets` | Target profit per entitas/periode (ubah saat berjalan wajib beralasan ≥10 karakter). ⚠️ [[ADR - 0079 Target Profit Satu Pintu di Insentif, KPI Membacanya]] T1 di PR [#1767](https://github.com/bip-itteam-internal/bip-erp/pull/1767), belum merge per 2026-09-07: gerbang per level dan divisi (`gerbangTulisTarget`); **400** level tak dikenal (disimpan kanonik); **403** target diri sendiri, beda divisi, atau level supervisor oleh bukan finance/IT/Direktur; **503** hierarki karyawan tak terbaca |
