...
| GET | `/profit-dashboard/saya/keanggotaan` | 🟡 **belum ada** ([[ADR - 0081 Insentif Saya Pindah ke MyBharata di Dalam Slip Gaji]] M1). Level tempat pemanggil menjadi entitas skema profit (`icc`/`leader`/`supervisor`) dari hierarki dan pemetaan toko, **tanpa angka dan tanpa menghitung dashboard**; kosong bila bukan anggota. Dipakai MyBharata menentukan apakah kartu Insentif tampil, supaya daftar role yang punya skema profit tidak disalin ke aplikasi |
