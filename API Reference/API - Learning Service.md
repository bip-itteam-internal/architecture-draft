...
- **Klien**: pertanyaan di dialog penilaian web dan blok ringkasan HR merged lewat erp-frontend PR [#1631](https://github.com/bip-itteam-internal/erp-frontend/pull/1631) **2026-09-17 09:19 UTC** (deploy FE DEV sedang dibangun pipeline saat dicatat, PROD belum); MyBharata belum (ditunda). Deploy erp-frontend wajib **sesudah** learning-service.
