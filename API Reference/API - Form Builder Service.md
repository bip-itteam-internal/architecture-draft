...
> ⚠️ **Di branch bip-erp `feat/form-builder-satgas-kepatuhan` (PR [#1849](https://github.com/bip-itteam-internal/bip-erp/pull/1849)), belum merge, belum deploy** (2026-09-11). Keputusan: [[ADR - 0090 Inspeksi Satgas 5R dan K3 di Form Builder dengan Nilai dari Cek Ulang Terakhir]].
