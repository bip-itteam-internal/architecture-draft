...
- Sumber: open.shopee.com/documents/v2/logistics.get_booking_shipping_document_parameter?type=1 (backend doc/api) — 2026-07-18
...
| `response.result_list[].selectable_shipping_document_type` | string[] | The shipping document type you can select of this booking. |
