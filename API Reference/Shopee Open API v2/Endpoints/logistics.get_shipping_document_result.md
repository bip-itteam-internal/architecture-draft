...
- Sumber: open.shopee.com/documents/v2/logistics.get_shipping_document_result?type=1 (backend doc/api) — 2026-07-18
...
|---|---|---|---|
| `order_list` | object[] | ya | The list of orders, limit [1,50] |
...
| `response.result_list` | object[] | The result data list of the API response. |
...
| `response.result_list[].status` | string | The status of the shipping document task you querying with order_sn. Available values: READY， FAILED， PROCESSING |
