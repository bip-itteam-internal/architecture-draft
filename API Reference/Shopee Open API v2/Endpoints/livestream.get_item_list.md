...
- Method: GET
- Auth: user
- Deskripsi: Get the detail information of item in item bag, including item id, item serial number, etc.(For TW, ID, TH, PH, MY, SG, VN)
- Sumber: open.shopee.com/documents/v2/livestream.get_item_list?type=1 (backend doc/api) — 2026-09-10
...
| `response.list[].item_no` | int64 | The order of this item in the shopping bag of current session, start from 1. |
