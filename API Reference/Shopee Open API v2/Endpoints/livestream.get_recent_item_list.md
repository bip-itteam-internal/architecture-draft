...
- Method: GET
- Auth: user
- Deskripsi: Get the item list of the Recently tab. (For TW, ID, TH, PH, MY, SG, VN)
- Sumber: open.shopee.com/documents/v2/livestream.get_recent_item_list?type=1 (backend doc/api) — 2026-09-10
