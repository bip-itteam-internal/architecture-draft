...
- **Status**: ⚠️ Implemented (ada catatan): kode lengkap di branch `feat/recruitment-lintas-perusahaan` (bip-erp, erp-frontend) dan `feat/nama-perusahaan-lowongan` (career-bharata) per 2026-09-11. **Belum merge, belum deploy**, paket belum terpasang ke posisi mana pun.
