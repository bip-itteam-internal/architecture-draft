...
- **`lines_hash` berubah untuk 338 dari 723** retur SENT yang menyentuh SKU paket lewat jalur gudang. **Tak ada sweep otomatis**, tapi begitu grup lama tersentuh (retry / member baru / scan susulan) dokumennya dihapus & dibukukan ulang dengan nilai baru — diinginkan, tapi jangan mengagetkan.
