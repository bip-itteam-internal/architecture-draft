...
- **Status**: 🟡 **Diusulkan**, disetujui manajemen 2026-09-07 lewat wawancara `/analisa-kebutuhan`. **T1 (gerbang tulis per level dan divisi) sudah dikodekan** di bip-erp branch `feat/insentive-gerbang-target` (test hijau, kontrol negatif terbukti, **belum merge, belum deploy**); T2 sampai T6 belum ada kodenya. Daftar task: `Workspace/ANALISA - Target Profit Satu Pintu.md` (papan kerja, bukan dok terbit).
