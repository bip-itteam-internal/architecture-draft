...
**Masa transisi (T18, 2026-09-12)**: data penandatangan per perusahaan belum ada (T6), jadi dokumen isian otomatis menulis Pihak Pertama dari **teks tetap template HR** dan menandainya sebagai keterangan yang selalu muncul di daftar kekurangan. Penyimpangan dari keputusan ini disengaja dan hanya untuk masa transisi; tanda tangan dan stempel direktur tidak dicetak. Rancangan akhir tetap mengambil penandatangan dari data per perusahaan. Rinciannya di dok domain §Masa transisi.
