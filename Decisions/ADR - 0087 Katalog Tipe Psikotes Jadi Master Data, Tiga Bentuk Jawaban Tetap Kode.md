> **Status**: ⚠️ **Diterima, merged, belum prod**: disetujui 2026-09-10; T1 sampai T6 dikodekan, terverifikasi di DEV, dan merged 2026-09-11; prod belum. Revisi layar kandidat (2026-09-11) **merged 2026-09-11**. DISC tanpa kunci skor (2026-09-15, penyimpangan 9) dikodekan di branch, **belum merged**. Rincian dan addendumnya di `## Deskripsi`.
...
- **Addendum DISC tanpa kunci skor** (2026-09-15, keputusan user; branch bip-erp `feat/recruitment-disc-lembar-jawaban` dan erp-frontend `feat/psikotes-disc-lembar-jawaban`, **belum merged**). Penyimpangan sadar dari Decision 2 ("tally empat dimensi"), Decision 7 ("menggambar grafik"), dan Consequences ("CFIT dan DISC berhenti dikoreksi dengan tangan"):
