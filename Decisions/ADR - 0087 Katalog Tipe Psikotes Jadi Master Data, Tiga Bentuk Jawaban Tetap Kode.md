...
- **Addendum bank CFIT diisi soal internal** (2026-09-16, keputusan user: "hrd gak ada, jadi saya ingin km yg membuat soalnya sekalian"). Menjawab risiko legalitas CFIT dengan cara tidak memakai bahan berlisensi sama sekali, bukan dengan menunggu izin:
	...
	- (10b) **Tanpa perubahan kode repo**: soal dimuat lewat API yang sudah ada (unggah gambar lalu `POST /psikotes/item` per soal, karena impor Excel teks saja). DEV dimuat agent 2026-09-16 dan alur kandidat diuji penuh lewat API publik; PROD dijalankan manusia.
