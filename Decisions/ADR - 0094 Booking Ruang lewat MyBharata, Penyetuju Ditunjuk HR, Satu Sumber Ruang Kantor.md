...
- **Alasan riwayat buatan server masih teks bahasa Indonesia** yang tampil apa adanya di locale en; dibuat terstruktur bersama layar MyBharata (irisan 2). *Irisan 2 (branch, belum merge per 2026-09-15): aksi sistem menyimpan `jadwal_sebelumnya` dan `nomor_terkait`, dan web serta MyBharata merakit kalimatnya lewat i18n; riwayat lama tetap teks.*
