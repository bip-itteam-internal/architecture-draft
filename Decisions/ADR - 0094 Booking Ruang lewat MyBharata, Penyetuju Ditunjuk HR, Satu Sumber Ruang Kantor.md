...
- **Status**: ⚠️ **Diterima, sebagian terimplementasi** (keputusan 2026-09-12, disempurnakan hasil review 2026-09-14). Irisan 1 dan 1b ada di kode dan di prod (1b merged dan naik 2026-09-15, lihat [[ADR - 0095 Pengajuan dan Persetujuan Booking Ruang Juga Lewat Web]]); irisan 2 merged 2026-09-15 (bip-erp #1898 dan #1899, erp-frontend #1587, my-bharata #149 ke `dev`), belum di PROD maupun store; irisan 3 sampai 7 belum. **§2, satu butir Consequences, dan satu butir "Yang sengaja tidak dilakukan" diamandemen [[ADR - 0095 Pengajuan dan Persetujuan Booking Ruang Juga Lewat Web]]** (2026-09-14): web kini juga mengajukan dan memutus booking.
...
- **Alasan riwayat buatan server masih teks bahasa Indonesia** yang tampil apa adanya di locale en; dibuat terstruktur bersama layar MyBharata (irisan 2). *Irisan 2 (merged 2026-09-15, belum di PROD): aksi sistem menyimpan `jadwal_sebelumnya` dan `nomor_terkait`, dan web serta MyBharata merakit kalimatnya lewat i18n; riwayat lama tetap teks.*
