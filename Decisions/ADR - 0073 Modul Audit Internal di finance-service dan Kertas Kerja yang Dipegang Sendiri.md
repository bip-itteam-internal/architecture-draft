...
- **Status**: ⚠️ **Implemented (ada catatan)** — backend fase 1 **merged** ([#1676](https://github.com/bip-itteam-internal/bip-erp/pull/1676)); [#1679](https://github.com/bip-itteam-internal/bip-erp/pull/1679) yang mengirim `keadaan_efektif` ke JSON **masih OPEN**; layar fase 2 selesai & ber-test di branch `feat/finance-audit-internal-fe` (**belum merge**). **Belum di-deploy dan belum pernah dijalankan lewat gateway.** Lihat "Belum selesai" di bawah.
