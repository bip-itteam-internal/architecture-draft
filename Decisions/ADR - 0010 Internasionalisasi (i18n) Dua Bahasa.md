...
1. **Default Bahasa Indonesia (`id`)**, opsi English (`en`). Pemilihan lewat **switcher di header** (bersebelahan dengan toggle tema); pilihan disimpan di **cookie `lang`** dan dibaca **server-side** di root layout (`<html lang>`, anti-flash/SSR konsisten).
