...
- **Status**: 🟡 Diputuskan dan dikodekan, **belum merged dan belum deploy** (2026-09-17). Kode di tiga branch: bip-erp `feat/marketing-analytics-karya-live-support` (marketing-analytics, notification-service, shared-library), bip-erp `feat/employee-karya-live-support` (employee-service), erp-frontend `feat/live-support-karya`. Test hijau di ketiganya; layar diverifikasi di Chrome atas hasil build dengan stub API. Belum pernah dipanggil lewat gateway mana pun.
- **Tanggal**: 2026-09-17
