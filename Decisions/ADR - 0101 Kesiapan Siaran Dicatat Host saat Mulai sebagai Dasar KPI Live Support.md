...
- ⛔ **Skor Live Support TETAP diisi manual.** `layakDifinalisasi` menuntut seluruh metrik punya `auto` dan nilai; tema dan teaser (bobot 0,70) tak punya sistem pencatat.
