...
> ⛔ **GUGUR 2026-09-15**: kategori sidebar `audit` dan rute `/audit*` dicabut dari erp-frontend ([[ADR - 0098 Audit Internal Beralih ke Uji Petik Dua Arah Manual]]); alamat lamanya dialihkan ke aplikasi audit. Empat entri `audit.*: tolak` di `FALLBACK` tetap dipertahankan. Bila menu audit kelak dipasang lagi di ERP, keputusan di bawah hidup kembali.
