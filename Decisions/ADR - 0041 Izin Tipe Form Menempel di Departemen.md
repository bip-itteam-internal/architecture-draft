...
- **Status**: ⚠️ **LIVE di dev DAN prod** (prod deploy manual 2026-08-09). Teruji end-to-end di dev; **di prod baru terverifikasi sampai boot**, alur berautentikasinya belum dijalankan. Merged 2026-08-08 (BE [#1099](https://github.com/bip-itteam-internal/bip-erp/pull/1099), FE [erp-frontend#866](https://github.com/bip-itteam-internal/erp-frontend/pull/866)). Bukti dan batasnya di [[Microservices - Form Builder Service]]. Desain kerja: `erp/docs/superpowers/specs/2026-08-08-tipe-form-per-departemen-design.md`
