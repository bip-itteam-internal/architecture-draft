...
- ⛔ **DIBATALKAN (2026-09-02) — "Satu menu hilang (Teams)" TIDAK terjadi.** Fungsi kepemilikan toko→divisi memang pindah ke kartu team ICC Management, tapi menu Teams TETAP HARUS ADA: ia juga melayani ACL "siapa boleh lihat toko apa" (`AllowedShops`, dipakai puluhan halaman Accurate/payouts/gross-profit) yang belum punya pengganti. Lihat koreksi di §Migrasi langkah 4.
