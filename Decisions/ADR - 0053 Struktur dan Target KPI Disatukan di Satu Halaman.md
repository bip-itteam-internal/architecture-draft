...
Pembatalan itu menyisakan `weight` ditulis dari dua layar lewat endpoint yang sama, dan yang belakangan menyimpan menang tanpa ada yang diberi tahu. Yang menuntaskannya bukan perbaikan teknis melainkan **kesepakatan yang waktu itu belum ada**: struktur (metrik dan porsi) milik HR, target dan sumber data milik atasan yang menilai. Setelah itu disepakati, isian Bobot dan saklar Aktif dicabut dari Atur Target ([#1237](https://github.com/bip-itteam-internal/erp-frontend/pull/1237), merged 2026-08-26). ⚠️ Amandemen 2026-09-07: untuk **target profit** metrik sumber insentif, "milik atasan yang menilai" tetap berlaku sebagai ORANGNYA (SPV Marketing), tetapi TEMPATNYA pindah ke insentif dan Atur Target hanya menampilkannya, lihat [[ADR - 0079 Target Profit Satu Pintu di Insentif, KPI Membacanya]].
